package com.abfinance.api.client.websocket.callback;
...
import com.abfinance.api.client.util.*;
...
public class WebSocketApiRequestHandler {
    ...
    public WebSocketApiRequestHandler(WebSocketConnection connection, String apiKey, SignatureGenerator signatureGenerator) {
        if (connection == null) {
            throw new ABFinanceApiException("[WebSocketApiRequestHandler] WebSocketConnection cannot be null");
        }
    ...
    public void request(RequestType requestType, String method, JSONObject parameters) {
        ...
        switch (requestType) {
            ...
            case SIGNED:
                ...
                break;
            default:
                throw new ABFinanceApiException("[WebSocketApiRequestHandler] Invalid request type: " + requestType);
        }
    }
}
