...
public interface WebsocketStreamClient {
     ...
     * If there is a problem on ABFinance's end, a snapshot will be re-sent, which is guaranteed to contain the latest data.
     * INFO
     ...
     * https://abfinance.com/docs/docs/v5/websocket/public/orderbook
     ...
     * https://abfinance.com/docs/docs/v5/websocket/public/trade
     ...
     * Topic:
     * tickers.{symbol}
     * https://abfinance.com/docs/docs/v5/websocket/public/ticker
     ...
     * https://abfinance.com/docs/docs/v5/websocket/public/kline
     ...
     * https://abfinance.com/docs/docs/v5/websocket/public/liquidation
     ...
     * https://abfinance.com/docs/docs/v5/websocket/public/etp-kline
     ...
     * https://abfinance.com/docs/docs/v5/websocket/public/etp-ticker
     ...
     * https://abfinance.com/docs/docs/v5/websocket/public/etp-nav
     ...
     * https://abfinance.com/docs/docs/v5/websocket/private/position
     ...
     * Categorised Topic: Allow you to listen only to specific category websocket updates
     * https://abfinance.com/docs/docs/v5/websocket/private/execution
     ...
     * All-In-One topic: Allow you to listen to all categories (spot, linear, inverse, option) websocket updates
     * Categorised Topic: Allow you to listen only to specific category websocket updates
     * https://abfinance.com/docs/docs/v5/websocket/private/order
     ...
     *
     * Topic: wallet
     * https://abfinance.com/docs/docs/v5/websocket/private/wallet
     ...
     *
     * Topic: greeks
     * https://abfinance.com/docs/docs/v5/websocket/private/greek
     */
     ...
     *
     * Topic: dcp
     * https://abfinance.com/docs/docs/v5/websocket/private/dcp
     */
}
