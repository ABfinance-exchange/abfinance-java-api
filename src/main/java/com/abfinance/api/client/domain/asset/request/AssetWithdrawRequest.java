/**
 ...
 forceChain=2: fill ABFinance UID, and it can only be another ABFinance main account UID. Make sure you add UID in the address book first
 ...
 */
package com.abfinance.api.client.domain.asset.request;
