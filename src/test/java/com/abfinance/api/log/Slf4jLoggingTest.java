...
public class Slf4jLoggingTest {
    ...
    public void setup() {
        // Get Logback Logger
        Logger logger = (Logger) LoggerFactory.getLogger(ABFinanceApiServiceGenerator.class);
    ...
    public void testInterceptorLogsHeaders() {
        // Trigger the logging
        ABFinanceApiClientFactory.newInstance(ABFinanceApiConfig.TESTNET_DOMAIN, true, "slf4j")
